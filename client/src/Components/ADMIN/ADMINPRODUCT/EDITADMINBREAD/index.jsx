...
function Admineditbread() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:5000/api/productsbread/find/${id}`).then((response) => {
            ...
            <div className='addProduct'>
                ...
                <div className='form-main'>
                    <Formik
                        ...
                        onSubmit={(values) => {
                            axios.put(`http://localhost:5000/api/productsbread/${post._id}`, {
                                title: values.title,
