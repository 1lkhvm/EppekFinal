...
function Admineditfarm() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:5000/api/productferma/find/${id}`).then((response) => {
            ...
            <div className='addProduct'>
                ...
                <div className='form-main'>
                    <Formik
                        ...
                        onSubmit={(values) => {
                            axios.put(`http://localhost:5000/api/productferma/${post._id}`, {
                                title: values.title,
